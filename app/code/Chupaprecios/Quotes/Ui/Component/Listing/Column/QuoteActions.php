<?php
namespace Chupaprecios\Quotes\Ui\Component\Listing\Column;
...
class QuoteActions extends Column {
    const FORM_URL_PATH_EDIT = 'Quotes/Quotes/editform';
    const FORM_URL_PATH_DELETE = 'Quotes/Quotes/deleteform';
